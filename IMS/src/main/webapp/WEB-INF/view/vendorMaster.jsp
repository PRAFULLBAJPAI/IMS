...
<link rel="stylesheet" href="./css/vendorMaster.css" />
...
<body style="font-size: 12px; background-color: #DCECFE;">
	...
	<div class="col-md-12">
		...
		<h5 class="heading">Vendor Master</h5>
							...
							<table id="example" class="table table-striped table-bordered">
								...
								<tbody>
									<c:forEach items="${vendorList.payload}" var="vendor">
										<tr>
											<td><a href="#"
												onclick="fetchVendor('${vendor.vendorId}')">${vendor.vendorId}</a></td>
											<td><a href="#"
												onclick="fetchVendor('${vendor.vendorId}')">${vendor.vendorName}</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
									...
									<div class="">
										...
										<form id="vendorForm" name="vendorForm">
											<div style="border: 1.75px solid #6595ff;">
												<b style="margin-left: 0.5%; color: #1649A2;">Vendor
													Details</b>
												<div class="mb-3 row" style="margin: 1%;">
													<label class="custom-field one col-md-2"> <input
														type="text" placeholder=""
														class="form-control form-control-sm" id="vendorId"
														value="${vendorMasterDTO.vendorId}" readonly /> <span
														class="placeholder">Vendor ID</span>
													</label> <label class="custom-field one col-md-4"> <input
														type="text" placeholder=""
														class="form-control form-control-sm " id="vendorName" />
														<span class="placeholder">Vendor Name</span>
													</label> <label class="custom-field one col-md-4"> <input
														type="text" placeholder=""
