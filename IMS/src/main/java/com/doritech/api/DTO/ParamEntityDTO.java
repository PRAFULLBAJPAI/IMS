...
public class ParamEntityDTO {
   ...
   public String toString() {
      return "ParamEntityDTO [id=" + this.id + ", code=" + this.code + ", serial=" + this.serial + ", descp1=" + this.descp1 + ", descp2=" + this.descp2 + ", descp3=" + this.descp3 + ", descp4=" + this.descp4 + ", descp5=" + this.descp5 + ", param1=" + this.param1 + ", param2=" + this.param2 + ", param3=" + this.param3 + ", param4=" + this.param4 + ", param5=" + this.param5 + "]";
   }
}
